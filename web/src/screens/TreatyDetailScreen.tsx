...
export default function TreatyDetailScreen() {
    ...
    const exhaustionPoint = topLayer ? topLayer.attachment + topLayer.limit : undefined;
        ...
        <>
            ...
            >
                <div className="header-actions">
                    ...
                    >
                        {item.status === TreatyStatus.Bound ? "Endorse" : "Bind treaty"}
                    </button>
                </div>
            </PageHeader>
            ...
            <div className="stats-grid">
                {[
                    ...
                    [
                        "Exhaustion point",
                        exhaustionPoint === undefined ? "—" : fmtM(exhaustionPoint),
                    ],
